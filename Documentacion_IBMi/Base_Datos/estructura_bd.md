...
| `BAHIS` | Histórico de Cuentas por Pagar | Banco, Sucursal, Origen de la Cuenta, Tipo de Cuenta, Cliente, Número de Referencia, Tipo de Registro, Fecha. |
...
| cuenta_o_cliente | VARCHAR | 50 | SI | NO | Valor de id_cliente o numero_cuenta segun tipo_entidad |
| tipo_entidad | CHAR | 1 | NO | NO | C=cliente (CUMST), A=cuenta (ACMST) |
| id_cliente | VARCHAR | 30 | NO | SI | CUMST.id_cliente |
| numero_cuenta | VARCHAR | 24 | NO | SI | ACMST.numero_cuenta |
| secuencia | INT | - | SI | NO | - |
| tipo_persona | VARCHAR | 20 | NO | NO | - |
